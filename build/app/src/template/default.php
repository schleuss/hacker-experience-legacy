...
if(isset($_SERVER['HTTP_HOST'])){
    if($_SERVER['HTTP_HOST'] == 'br.'.$appDomain){
        $fbServerURL = 'http://br.'.$appDomain.'/';
    } elseif($_SERVER['HTTP_HOST'] == 'en.'.$appDomain){
        $fbServerURL = 'http://en.'.$appDomain.'/';
    }
}
...
switch($fbServerURL){
    case 'http://'.$appDomain.'/':
        ...
        $appSecret = 'REDACTED';
        break;
    case 'http://br.'.$appDomain.'/':
        $appID = 0;
        $appSecret = 'REDACTED';
        break;
    case 'http://en.'.$appDomain.'/':
        $appID = 0;
        $appSecret = 'REDACTED';
        break;
}
...
//if($_SERVER['HTTP_HOST'] == 'www.'.$appDomain || $_SERVER['HTTP_HOST'] == ''.$appDomain){
//    $url = 'http://'.$appDomain.'/';
//} else {
//    $url = 'http://127.0.0.1/';
//}
...
?>
                    ...
                    <dd>
                        <ul>
                            <li><a href="//en.<?php echo $appDomain; ?>/"><img class="flag" src="images/en.png" alt="" /> English</a></li>
                            <li><a href="//br.<?php echo $appDomain; ?>/"><img class="flag" src="images/pt.png" alt="" /> Português</a></li>
                        </ul>
                    </dd>
                </dl>
            </div>
            ...
            <div class="row">
                ...
                <div id="contact" class="four columns text-right">
                    ...
                    <div class="mail-link">
                        ...
                        <a href="mailto:<?php echo _($appDomain); ?>"><i class="fa fa-envelope-o"></i><?php echo _($appDomain); ?></a><br/>
                    </div>
