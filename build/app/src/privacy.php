...
<ul>- <?php echo _('Cookies - We use cookies to enable a more personal experience on the game. We do not track other sites than '.$appDomain.'. Hacker Experience might not work without cookies.'); ?></ul>
...
<ul>- <?php echo _('The use of the site constites your full acceptance of our Privacy Policy. If you do not agree with it, please refrain from using '.$appDomain.' and all related domains.'); ?></ul>
...
<iframe style="border: 0; height: 200px; width: 600px;" src="http://piwik.<?php echo _($appDomain); ?>/index?module=CoreAdminHome&action=optOut&language=<?php echo $piwik_l; ?>"></iframe>
<br/><br/>
