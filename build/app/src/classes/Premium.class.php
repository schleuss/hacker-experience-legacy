...
class Premium {
    ...
    public function handlePost(){
        ...
        if(self::playerHasPayment()){
            $system->handleError('There already is a payment of yours being processed. For safety reasons we won\'t accept this new one. If you think this is an error, mail us at '.$contactMail, $redirect);
        }
...
//        $stmt->execute(array(':id' => $id));
        ...
        if($report){
            ...
            $ses->send('price_mismatch', Array('to' => $contactMail,  'id' => $id), '');
...
?>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content padding">
                    ...
                    <br/>
                    <?php echo _('Questions? Drop us an email at ')._($contactMail); ?>
                </div>
            </div>
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <?php echo _('That\'s right, we accept Bitcoin! The price is the same (converted from USD to BTC).'); ?>
                                 <br/><br/>
                                <?php echo _('The bitcoin payment gateway is not ready yet. Please send an email to ')._($contactMail)._(' so we can send the instructions on how to perform the payment.'); ?>
